...
function displayList() {
  ...
  for (var i = 0; i < p.length; i++) {
    ...
    input1.setAttribute("style", "width:50px;float:left;margin-left:100px;text-align:center; color: black");
    ...
    input2.setAttribute("style", "width:50px;float:left;margin-left:100px;text-align:center; color: black");
    var input3 = document.createElement("input");
    input3.value = p[i].pri;
    input3.setAttribute("class", "form-control text-primary");
    input3.setAttribute("disabled", "disabled");
    input3.setAttribute("id", "pri" + i);
    input3.setAttribute("style", "width:50px;float:left;margin-left:100px;margin-right:100px;text-align:center; background-color: black;");
