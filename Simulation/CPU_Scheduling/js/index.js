...
function displayList() {
  ...
  for (var i = 0; i < p.length; i++) {
    ...
    input1.setAttribute("style", "width:50px; height:45px; float:left;margin-left:100px;text-align:center; text");
    ...
    input2.setAttribute("style", "width:50px; height:45px; float:left;margin-left:100px;margin-right:100px;text-align:center; color: black");
